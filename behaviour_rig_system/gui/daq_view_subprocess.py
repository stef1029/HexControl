...
# Ensure the behaviour_rig_system package root is on sys.path so that
# "gui.theme" and "gui.daq_view_widget" resolve correctly.
from pathlib import Path

_pkg_root = Path(__file__).resolve().parents[1]  # behaviour_rig_system/
