...
from hexcontrol.autotraining.engine import AutotrainingEngine
from hexcontrol.autotraining.definitions.visual.stages import STAGES
from hexcontrol.autotraining.definitions.visual.graph import TRANSITIONS
from hexcontrol.core.tracker import Tracker, TrackerDefinition, Trial
...
# Test persistence
from hexcontrol.autotraining.persistence import load_training_state, save_training_state
import tempfile, os
