import sys
sys.path.insert(0, '/lmb/home/srogers/Dev/projects/DeepLabCut')
...
config = r'/cephfs2/srogers/DEEPLABCUT_models/2500601_Pitx2_ephys_model/project_folders/Tetrodes_superanimal-StefanRC-2025-07-24/config.yaml' # superanimal model for tetrodes
