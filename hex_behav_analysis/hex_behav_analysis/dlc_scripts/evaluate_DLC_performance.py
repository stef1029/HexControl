...
if __name__ == "__main__":
    ...
    model = "DLC_HrnetW32_Tetrodes_superanimalJul24shuffle1_snapshot_best-185"

    
    cohort_dir = r"/cephfs2/srogers/Behaviour/2504_pitx_ephys_cohort"
    
    cohort = Cohort_folder(cohort_dir, multi=True, OEAB_legacy=False, dlc_model_name=model, use_existing_cohort_info=False)
    test_dir = cohort.get_session("250513_124334_mtaq14-1j")
